...
export OPLUS_FEATURE_APP_MONITOR=yes
...
export OPLUS_FEATURE_MIC_MUTE=true
...
export OPLUS_FEATURE_DFPS3_SUPPORT=yes
export OPLUS_FEATURE_IGNORE_ICC=yes
export OPLUS_FEATURE_OSIE_MTK=yes
...
export TARGET_PRODUCT=vnd_oppo6785
